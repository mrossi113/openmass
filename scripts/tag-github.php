...
// This is just a test line to use to check if the following lines work.
$branch = "Merge pull request #206 from massgov/release/0.235.0";

// Find the most recent tag in GitHub master branch to update.
//$version = new SemVer\Version(`git describe --abbrev=0 --tags`);

// Adjust the $version test the minor, patch, and major increment changes
$version = new SemVer\Version("1.0.0");
...
// uncomment if want to test the git tag.
